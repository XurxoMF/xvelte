...
A native action control with six visual variants, eight sizes, predictable form behavior, disabled and invalid states, and automatic spacing for inline icons. It also exports its Tailwind Variants function so your own elements can use the same visual style.
...
<Button.Root aria-invalid="true" aria-describedby="delete-error" variant="destructive">Delete account</Button.Root>
<p id="delete-error" class="text-sm text-destructive">Confirm your password before deleting the account.</p>
```
...
| ---------- | ------------------------------------------------------------------------------------ | ----------- | ---------------------------------------------------------------------------------------------------- |
| `variant`  | `"default" \| "outline" \| "secondary" \| "ghost" \| "destructive" \| "link"`        | `"default"` | Selects the visual treatment generated by `rootVariants`.                                            |
...
| `destructive` | Tinted destructive surface and text with destructive focus treatment and stronger dark-mode hover.                                                  |
...
- Destructive border/ring styling for `aria-invalid="true"`.
