...
- `index.ts`
- `calendar-range.md`
  Follow the Button component's unit guide to install it and understand its variants, native API, styling, accessibility, and theme requirements. PrevButton and NextButton import Button's public variant helper and type. No other xvelte component, hook, attachment, context module, shared style, font, image, or network service is required.
...
| `calendar-range.md`                  | Usage, API, styling, accessibility, localization, dependencies, and credits.  |
