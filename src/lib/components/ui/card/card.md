...
Card requires no icon export, UI component, hook, attachment, context file, localization message, shared component stylesheet, animation package, or global keyframe. Components shown inside Card examples have their own installation requirements; follow each component's unit guide when you use them.
