...
<script lang="ts">
	...
	Chart.setChartContext({
		/** Current reactive series configuration. */
		get config() {
			return config;
		}
	});
...
<div
	...
	class={cn(
		...
		// Remove LayerChart's default hover outlines and guide line.
		"[&_.lc-highlight-point]:stroke-transparent",
		"[&_.lc-line]:stroke-border/50",
		"[&_.lc-highlight-line]:stroke-0",
		// Preserve every stacked series while hovering and normalize chart text sizing.
