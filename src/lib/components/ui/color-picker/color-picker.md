...
The complete public component folders above also import these components through their own `index.ts` files, so copy them as well and follow their unit guide guides:
...
| `color-picker.md`          | Installation, usage, public API, behavior, accessibility, dependencies, and provenance guide.                    |
