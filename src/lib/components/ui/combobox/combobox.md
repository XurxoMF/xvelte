...
Copy these complete xvelte component folders and follow each component's unit guide to install it and understand its API:
...
The complete Command folder imports these components through its public `index.ts`, so copy them as well and follow their unit guide guides:
...
| `combobox.md`                | Installation, composition, examples, API, styling, accessibility, localization, and dependency guide. |
