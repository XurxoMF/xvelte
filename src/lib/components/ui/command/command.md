...
Copy the complete Dialog and Input Group components and follow each component's unit guide to install it and understand its API:
...
Those complete component folders import these components through their own `index.ts` files, so copy them as well and follow their unit guide guides:
...
| `command.md`               | Installation, composition, examples, API, styling, accessibility, localization, dependencies, and credits.          |
