...
Follow the Button component's colocated unit guide to install and understand its complete API and requirements. Date Strip uses its ghost variant and icon size internally; no other xvelte component is required.
...
| `date-strip.md`          | Installation, composition, examples, API, styling, accessibility, localization, dependencies, and credits.                    |
