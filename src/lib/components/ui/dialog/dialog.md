...
Follow the Button component's colocated unit guide to install and understand its complete API and requirements. Dialog uses Button for Content's icon close and Footer's optional text close; Button is required even when both options are disabled at runtime.
...
| `dialog.md`                 | Installation, composition, examples, API, styling, accessibility, localization, dependencies, and credits.            |
