...
export type EmojiPickerRootProps = WithoutChild<Omit<CommandPrimitive.RootProps, "filter" | "shouldFilter" | "columns" | "onValueChange">> &
...
export type EmojiPickerListProps = WithoutChildren<WithoutChild<CommandPrimitive.ListProps>> & EmojiPickerListPropsWithoutHTML;
...
export type EmojiPickerFooterProps = WithoutChildren<HTMLAttributes<HTMLDivElement>> & EmojiPickerFooterPropsWithoutHTML;
