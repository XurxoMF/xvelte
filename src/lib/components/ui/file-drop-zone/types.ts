...
export type FileDropZoneRootProps = FileDropZoneRootPropsWithoutHTML & Omit<HTMLInputAttributes, "multiple" | "files" | "id" | "class">;

export type FileDropZoneTriggerPropsWithoutHTML = WithChildren<{ ref?: HTMLLabelElement | null }>;
