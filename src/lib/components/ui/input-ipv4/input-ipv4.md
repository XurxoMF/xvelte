...
Copy the complete `src/lib/components/ui/input-ipv4` component folder, including `index.ts`, `input-ipv4-root.svelte`, the utility file, and this guide.
...
| `input-ipv4.md`          | Installation and usage guide.                                                                  |
