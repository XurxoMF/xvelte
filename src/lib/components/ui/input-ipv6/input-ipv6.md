...
Copy the complete `src/lib/components/ui/input-ipv6` component folder, including `index.ts`, `input-ipv6-root.svelte`, the utility file, and this guide.
...
| `input-ipv6.md`          | Installation and usage guide.                                                                    |
