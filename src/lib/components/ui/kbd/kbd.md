...
- `index.ts`
- `kbd.md`
  Buttons, tooltips, input groups, menus, and other components shown around Kbd are optional compositions. Copy them and follow their own unit guide only when using them.
...
| `kbd.md`           | Installation, API, accessibility, and usage guide. |
