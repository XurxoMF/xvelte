...
`Select.Separator` reuses the Separator component. Copy its folder and follow its unit guide to install it:
...
| `select.md`                        | Composition, examples, API, accessibility, styling, and installation guide.   |
