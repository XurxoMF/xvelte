...
The generated close control uses Button. Copy its component folder and follow Button's unit guide to install its API, icons, tokens, and dependencies:
...
| `sheet.md`                 | Composition, examples, API, accessibility, localization, styling, and installation guide.          |
