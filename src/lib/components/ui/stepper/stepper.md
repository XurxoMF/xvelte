...
Stepper has no external state primitive or icon dependency. Button may add its own runtime and development packages; follow its unit guide.
...
Previous and Next reuse Button. Copy its component folder and follow its unit guide for the complete installation requirements:
...
| `stepper.md`                 | Composition, examples, API, behavior, accessibility, styling, and installation guide. |
