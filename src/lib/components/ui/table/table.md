...
These are Table's direct tokens. Follow Scroll Area's unit guide for its additional `ring` token and orientation variants. Theme values may be replaced by the app.
...
Copy Scroll Area and follow its unit guide:
...
| `table.md`             | Composition, examples, API, semantics, styling, and installation guide. |
